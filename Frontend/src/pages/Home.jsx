    ...
    <div className="home-container">
      <header className="hero-section text-center text-white d-flex align-items-center justify-content-center">
        ...
        <div className="container">
          ...
          <p className="lead mb-5 app-slide-up" style={{ animationDelay: "80ms" }}>From quick repairs to complete pipeline installations, Aquafix delivers reliable and professional plumbing services designed for your comfort and peace of min</p>
            ...
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm p-4 app-hover-lift app-fade-in">
                <div className="card-body text-center">
                  ...
                  <p className="card-text text-muted">Precision pipeline installation designed to ensure efficient water flow and long-lasting performance for residential and commercial properties.</p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm p-4 app-hover-lift app-fade-in" style={{ animationDelay: "70ms" }}>
                <div className="card-body text-center">
                  ...
                  <p className="card-text text-muted">Routine maintenance and expert repairs to keep your plumbing system functioning smoothly without unexpected disruptions.</p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card h-100 border-0 shadow-sm p-4 app-hover-lift app-fade-in" style={{ animationDelay: "140ms" }}>
                <div className="card-body text-center">
                  ...
                  <p className="card-text text-muted">Immediate assistance for urgent plumbing problems including leaks, blockages, pipe damage, and water flow issues.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <footer className="cta-section py-5 text-center bg-primary text-white">
        <div className="container">
          <h2 className="mb-4">Need Professional Plumbing Assistance?</h2>
          <p className="lead mb-4">Submit your request today and let Aquafix professionals handle your plumbing challenges quickly and efficiently.</p>
